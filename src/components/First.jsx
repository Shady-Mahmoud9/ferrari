...
function First() {
  ...
  return (
    ...
    <div  className='w-full overflow-x-hidden  overflow-y-hidden flex flex-col items-center  md:h-[600px]' style={{ background: `url(${bg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
      ...
      <div  className='w-full lg:-p-0 p-10 bg-none lg:bg-white flex items-center justify-center'><img data-aos="zoom-in" data-aos-duration="2000" src={ferrarimen} className= 'mt-0 md:-mt-16 lg:-mt-[310px]  w-[750px] ' alt="" />
      </div>
    </div>
    <div data-aos="zoom-in" data-aos-duration="2000" className='bg-white mt-40 flex flex-col text-center justify-center items-center p-10 md:p-3'>
