...
function First() {
  ...
  return (
    ...
    <div  className='w-full overflow-x-hidden  overflow-y-hidden flex flex-col items-center  md:h-[600px]' style={{ background: `url(${bg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
      ...
      <div  className='w-full p-10 bg-none lg:bg-white flex items-center justify-center'><img data-aos="zoom-in" data-aos-duration="2000" src={ferrarimen} className= 'mt-0 md:-mt-16 lg:-mt-64  w-[750px] ' alt="" />
      </div>
    </div>
